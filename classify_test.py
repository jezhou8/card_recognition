...
def main():
    frame = cv2.imread('cards/test6.jpg')
    ...
    if res:
        ...
        rank_text = classify(test_rank, 'rank', False)
        suit_text = classify(test_suit, 'suit', False)
        cv2.putText(frame, rank_text, (10, 50), font,
                    1, (0, 0, 255), 2, cv2.LINE_AA)
        cv2.putText(frame, suit_text, (10, 100), font,
                    1, (0, 0, 255), 2, cv2.LINE_AA)
